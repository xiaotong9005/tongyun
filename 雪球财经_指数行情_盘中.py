...
if strftime("%H:%M")<'14:55' or strftime("%H:%M")>'13:30':
        headers={
        'Accept':'*/*',
        ...
        for code in codelist:
            ...
            if len(datastr)>150:
                ...
                sql='''
                delete from [大盘指数行情中心_盘中] where time='%s' and symbol='%s';
                insert into [大盘指数行情中心_盘中] (update_time,symbol,name_cn,[current],pe_ttm,pe_lyr,pb,
